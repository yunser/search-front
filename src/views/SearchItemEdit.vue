<template>
    <my-page class="page-detail" title="搜索项" :page="page">
        <div class="common-container container">
            ...
            <br>
            <ui-text-field v-model="form.keywords" label="关键词" />
            <br>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            if (this.itemId) {
                this.$http.get(`/searchItems/${this.itemId}`).then(
                    response => {
        ...
        methods: {
            ...
            submit(e) {
                ...
                this.$http.put(`/searchItem/${this.itemId}`, {
